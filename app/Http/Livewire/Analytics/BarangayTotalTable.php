 ...
 * Class RolesTable.
 */
class BarangayTotalTable extends DataTableComponent
{

    public function mount($cityCode)
    {
        Session::put('city_code', $cityCode);
    }
    ...
    public function query(): Builder
    {
        ...
        $query = Barangay::where('barangays.city_municipality_code', Session::get('city_code'));
        return $query;
